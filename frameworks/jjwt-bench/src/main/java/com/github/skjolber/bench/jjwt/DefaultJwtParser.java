...
public class DefaultJwtParser implements JwtParser {
    ...
    private static class Decoder {
        ...
        public JwtSignatureValidator getValidator() {
            return createSignatureValidator(alg, key);
        }
    ...
    public Jwt parse(String jwt) throws ExpiredJwtException, MalformedJwtException, SignatureException {
        ...
        String base64UrlEncodedPayload = jwt.substring(index + 1, endIndex);
     ...
     */
    protected static JwtSignatureValidator createSignatureValidator(SignatureAlgorithm alg, Key key) {
